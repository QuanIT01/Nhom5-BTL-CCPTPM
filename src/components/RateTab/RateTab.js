  ...
  return (
    <div className="tab">
      ...
      >
        ...
        <Tab
          eventKey="comment"
          title="Nhận xét của các bạn"
          className="info-reviews review-text tab-pane fade in active"
        >
          <div className="tab">
            <div className="about-author">
              <div className="author-des">
                ...
                <p>
                  ...
                  Integer accumsan egestas eleifend. Phasellus a felis at est
                  bibenes dum feugiat ut eget eni Praesent et messages in
                  consectetur.
                </p>
              </div>
            </div>
