        ...
        <div className="header-top">
          <div className="container">
            ...
            <div className="ht-right">
              {userLocalStorage ? (
                <NavLink className="nav-link login-panel" to={"/homepage"}>
                  ...
                  <li className="cart-icon">
                    ...
                    <div className="cart-hover">
                      <div className="card-footer">
                        <div>Thành tiền: ${totalPrice}</div>
                      </div>
                      <div className="select-button">
                        <NavLink
                          className="primary-btn view-card nav-link"
                          to="/cart"
                        >
                          Xem giỏ hàng
                        </NavLink>
            ...
            <Navbar expand="lg" className="nav-item">
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto  mobile-menu">
                  ...
                  <li>
                    <NavLink to={"/shop"}>Tất cả sản phẩm</NavLink>
                  </li>
                  <li>
                    <NavLink to={"/orderadress"}>Thanh toán</NavLink>
                  </li>
                  <li>
